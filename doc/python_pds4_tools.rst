...
| Download the latest official release:
  `PDS4 tools-1.3.zip <https://pdssbn.astro.umd.edu/toolsrc/readpds_python/1.3/PDS4_tools-1.3.zip>`_.
...
Online `usage documentation <https://pdssbn.astro.umd.edu/tools/pds4_tools_docs/current/>`_,
